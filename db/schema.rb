...
ActiveRecord::Schema.define(version: 20200131124933) do
  ...
  create_table "attendances", force: :cascade do |t|
    ...
    t.boolean "attendance_change_change_approval"
    t.boolean "manager_approval_change_approval"
    t.integer "manager_approval_instructor_confirmation", default: 0
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "basic_work_time", default: "2020-02-02 23:00:00"
    t.datetime "designated_work_start_time", default: "2020-02-03 00:00:00"
    t.datetime "designated_work_end_time", default: "2020-02-03 09:00:00"
    t.integer "number_of_overtime_applied", default: 0
    t.integer "number_of_manager_approval_applied", default: 0
    t.integer "time_log_year"
    t.integer "time_log_month"
    t.integer "temp_year"
    t.integer "temp_month"
