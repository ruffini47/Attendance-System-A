...
# 残業申請_1カ月勤怠確認
  ...
  get '/users/:user_id/attendance/:id/confirm_one_month_approval/:hour/:min', to: 'attendances#confirm_one_month_approval', as: 'attendance_confirm_one_month_approval_user'
# 残業承認
